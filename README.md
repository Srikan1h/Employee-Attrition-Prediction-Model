...
**Key Features Data Preprocessing:** Handles missing values and converts categorical data into a numerical format suitable for machine learning models.
...
### Tech Stack The following technologies and libraries were used to build this project:
------------
...
###  How to Run the Project To run this project, you will need to have Python installed.
------------
...
##### Run the Jupyter Notebook: run the jupyter notebook: the project is contained within a single jupyter notebook. open it and run the cells sequentially to see the full pipeline in action.
